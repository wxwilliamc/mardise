            ...
            <div className='relative bg-white'>
              <div className='mx-auto max-w-7xl px-8'>
                <div className='grid grid-cols-3 gap-x-8 gap-y-10 py-16'>
                  <div className='grid grid-cols-3 col-span-3 col-start-1 gap-x-8'>
                    {category.featured.map((item) => (
                      <div key={item.name} className='group relative text-base sm:text-sm'>
                        {/* Image */}
                        <div className='relative aspect-video overflow-hidden rounded-lg bg-purple-100 group-hover:opacity-75'>
                          <Image 
                            src={item.imageSrc}
                            alt='item_image'
                            fill
